...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://converterhub.vercel.app'),
  ...
  openGraph: {
    ...
    description: siteDescription,
    url: 'https://converterhub.vercel.app',
    locale: 'en_US',
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                '@type': 'SearchAction',
                target: { '@type': 'EntryPoint', urlTemplate: 'https://converterhub.vercel.app/?q={search_term_string}' },
